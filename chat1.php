...
<body class="">
    ...
    <section class="vbox">
        <header class="bg-white header header-md navbar navbar-fixed-top-xs box-shadow">
            <div class="navbar-header aside-md dk"> <a class="btn btn-link visible-xs" data-toggle="class:nav-off-screen,open" data-target="#nav,html"> <i class="fa fa-bars"></i> </a> <a href="chat1.php?ids=<?php echo $id ?>&&id=<?php echo $ids ?>" class="navbar-brand"> <img src="images/logo.png" class="m-r-sm" alt="scale"> <span class="hidden-nav-xs"> Messenger</span>
            ...
            <ul class="nav navbar-nav navbar-right m-n hidden-xs nav-user user">
                <li class="hidden-xs"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="i i-chat3"></i> <span class="badge badge-sm up bg-danger count">2</span> </a>
                    <section class="dropdown-menu aside-xl animated flipInY">
                        <section class="panel bg-white">
                            ...
                            <div class="list-group list-group-alt"> <a href="#" class="media list-group-item"> <span class="pull-left thumb-sm"> <img src="images/a0.png" alt="..." class="img-circle"> </span> <span class="media-body block m-b-none"> Use
                ...
                <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <span class="thumb-sm avatar pull-left"> <img src="classes/afterlogin/image/<?php echo $all['image'] ?>" alt="..."> </span>
                        <?php echo $all['name'] ?><b class="caret"></b> </a>
        ...
        <section id="content">
            <section class="hbox stretch">
                <section>
                    <section class="vbox">
                        <header class="header bg-light lt b-b b-light"> <a href="profile.php?idss=<?php echo $id ?>" class="btn btn-sm btn-default pull-right btn-rounded">Profile</a>
                            <p>Chat with <strong><?php echo $colluct['nicname']; ?></strong></p>
                        ...
                        <section class="w-f scrollable wrapper">
                            ...
                            <section class="chat-list">
                                ...
                                <div id="showmy" style="margin-bottom:40px;">
                                    <div id="minchat">
                        ...
                        <footer class="footer bg-light lt b-t b-light" style=" position: fixed;
                            ...
                            <form id='from' action="<?php echo $_SERVER['PHP_SELF'] ?>?ids=<?php echo $id ?>&&id=<?php echo $ids ?>" method="POST" enctype="multipart/form-data" class="m-t-sm">
                                ...
                                <input type="file" id='image' name="images" accept="image/png,image/jpg" style="position:absolute;z-index:1;">
                                <div style="text-align: center; position:relative;height:1px" id="type"></div>
                                <p style="text-align: right; position:relative;margin-right:5px " id='seen'></p>
                                <div class="input-group">
                                    <input autocomplete="off" id="sms" name="sms" type="text" class="form-control input-sm rounded" placeholder="Say something" autofocus>
                                    <span class="input-group-btn"> <button name="submit" id='text' type="submit" class="btn btn-sm btn-danger font-bold btn-rounded" type="button">Send</button> </span>
                                </div>
                            </form>
                        </footer>
                    </section>
                ...
                <script>
                    (function($) {
                        ...
                        $(document).on('submit', 'form#from', function(event) {
                            ...
                            var sms = $('#sms').val();
                            var lod =
                                '  <article class="chat-item right"> <a href="#" class="pull-right thumb-sm avatar"> <div class="loader2"></div></a><section class="chat-body"><div class="panel bg-light dk text-sm m-b-none"><div class="panel-body"> <span class="arrow right"></span><p class="m-b-none">' +
                                sms +
                                ' </p></div></div> <small class="text-muted">now</small> </section></article>';
                            if (sms == "") {
                        ...
                        $(document).on('submit', 'form#from', function(event) {
                            ...
                            if (image == "") {
                                ...
                                var loadimg =
                                    '<article class="chat-item right"> <a href="#" class="pull-right thumb-sm avatar"><div class="loader2"></div></a><section class="chat-body"><div class="panel bg-light dk text-sm m-b-none"><div class="panel-heading b-b b-light"> <a href="#" data-toggle="class" class="pull-right m-l-sm m-t-xs"><i class="i i-pause i-lg text-muted text"></i><i class="i i-play i-lg text-muted text-active"></i></a> <span class="pull-left m-r-sm m-t-xs"><i class="i i-pictures i-lg text-muted"></i></span><div class="clear"><div class="progress progress-xs progress-striped active m-b-none m-t-sm"><div class="progress-bar bg-info dk" data-toggle="tooltip" data-original-title="40%" style="width: 0%"></div></div> <span>' +
                                    image +
                                    '</span> </div></div></div> <small class="text-muted">now</small> </section></article>';
                                $('.img').html(loadimg)
                                window.scrollTo(0, document.body.scrollHeight);
